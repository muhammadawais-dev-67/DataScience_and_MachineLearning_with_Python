...
x = ("banana" , "orange" , "apple" , "mangoes" , "awais" , "muhammad" , "opera-mini" , "pandas" , "series")
...
x = ("banana" , "orange" , "apple" , "mangoes" , "awais" , "muhammadi" , "opera-mini" , "pandas" , "series")
...
x = ("banana" , "orange" , "apple" , "mangoes" , "AWAIS" , "ali" , "opera-mini" , "pandas" , "series")
print(type(x))
y = list(x)
print(type(y))
y.remove("series")
